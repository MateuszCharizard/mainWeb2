...
// News Ticker Styles (updated to be strictly static and isolated from party effects)
const tickerStyles = `
  .news-ticker {
    position: fixed;
    top: 1rem;
    ...
    border-radius: 8px;
    cursor: pointer;
    transition: none !important; /* No positional transitions */
  }
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={toggleTheme}
        className="w-10 h-10 rounded-full fixed top-4 right-4 flex items-center justify-center shadow-lg z-100" // Higher z-index
        style={{
          appearance: "none",
          padding: "1em 2em",
          color: colors.text,
      ...
      <motion.button
        ...
        className="w-10 h-10 rounded-full fixed top-4 left-4 flex items-center justify-center shadow-lg z-100" // Higher z-index
        style={{
          appearance: "none",
          padding: "1em 2em",
          color: colors.text,
